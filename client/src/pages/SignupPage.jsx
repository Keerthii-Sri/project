...
export default function SignupPage() {
  ...
  const [form, setForm] = useState({ organization: 'Demo Logistics', email: 'admin@demo.com', password: 'demo1234' });
    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-100 px-4">
      <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 shadow-lg">
        <div className="mb-6 text-center">
          <div className="text-3xl font-black text-emerald-900">Create workspace</div>
          <p className="mt-2 text-sm text-slate-600">Set up your GreenFleet organization</p>
        </div>
